...
3. Open `AcmeBottling_Orders_Shipments.xlsx` in **Excel**.
...
1. Open `AcmeBottling_Master_Reference.xlsx` in **Excel** so you can see customer and
   supplier names on the **Customers** and **Suppliers** tabs.
...
3. In **Copilot Chat**, start a **New chat** (the pencil or **New chat** icon at the top
   of the pane).
4. When you prompt about this customer, work from that folder and that fresh chat so
...
1. Open a new **Word** document and save it into the Blue Ridge folder.
